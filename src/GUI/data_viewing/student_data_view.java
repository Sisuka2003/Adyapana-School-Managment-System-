 ...
 * @author DELL
 */
public class student_data_view extends javax.swing.JFrame {

    private final DefaultTableModel dtm;
    processModel pmodel;

    public student_data_view() {
        icon();
        initComponents();
        dtm = (DefaultTableModel) jTable1.getModel();
        pmodel = new processModel();
        pmodel.loadStudentTable("", dtm);
    ...
    private void initComponents() {
        ...
        dobField.setBackground(new java.awt.Color(213, 168, 127));
        dobField.setFont(new java.awt.Font("Segoe UI Semibold", 0, 13)); // NOI18N
        dobField.setForeground(new java.awt.Color(255, 255, 255));
        dobField.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(0, 0, 0)));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(dobField, javax.swing.GroupLayout.PREFERRED_SIZE, 272, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        String result = pmodel.student_register(name, address, dob);
        pmodel.loadStudentTable("", dtm);
...
//            suceed.popupstatus(result);
        ...
        } else if (result == "Student Registration Error") {
            fail f = new fail();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String result = pmodel.student_update(id, name, address, dob);
        pmodel.loadStudentTable("", dtm);

        if (result == "Student update success") {
            success suceed = new success();
//            suceed.popupstatus(result);
            suceed.setVisible(true);
        } else if (result == "Student Update error") {
            fail f = new fail();
            f.popupstatus(result);
            f.setVisible(true);
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String result = pmodel.student_delete(id);
        pmodel.loadStudentTable("", dtm);

        if (result == "Student delete success") {
            success suceed = new success();
//            suceed.popupstatus(result);
            suceed.setVisible(true);
        } else if (result == "Student delete error") {
            fail f = new fail();
            f.popupstatus(result);
            f.setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(student_data_view.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new student_data_view().setVisible(true);
            }
        });
    }
