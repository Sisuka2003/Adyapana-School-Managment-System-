 ...
 * @author DELL
 */
public class lading_page extends javax.swing.JFrame {

    /**
     * Creates new form lading_page2
     */
    public lading_page() {
        icon();
        initComponents();  
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/second-removebg-preview.png"))); // NOI18N
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 270, 210));

        jLabel1.setFont(new java.awt.Font("Segoe UI Semibold", 1, 15)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(56, 29, 4));
        jLabel1.setText("The Best Institute For Science");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lading_page.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new lading_page().setVisible(true);
//            }
//        });

lading_page lp=new lading_page();
lp.setVisible(true);
